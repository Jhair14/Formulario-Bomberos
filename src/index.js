...
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:3001', 'http://127.0.0.1:3001','http://localhost:5173','https://formulario-bomberos.vercel.app','formulario-bomberos-nqbe-9h8hbmf9i-jhair-andersons-projects.vercel.app'],
